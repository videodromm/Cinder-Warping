...
std::atomic<bool> Warp::sIsGammaMode{ false };
		...
		//! to json
		JsonTree	Warp::toJson() const
		{
			JsonTree		json;
			JsonTree warp = JsonTree::makeArray("warp");

			switch (mType) {
			case BILINEAR: warp.addChild(ci::JsonTree("method", "bilinear")); break;
			case PERSPECTIVE: warp.addChild(ci::JsonTree("method", "perspective")); break;
			case PERSPECTIVE_BILINEAR: warp.addChild(ci::JsonTree("method", "perspectivebilinear")); break;
			default: warp.addChild(ci::JsonTree("method", "unknown")); break;
			}
			...
			warp.addChild(ci::JsonTree("atexturefilename", mATextureFilename));
			warp.addChild(ci::JsonTree("btexturefilename", mBTextureFilename));
		...
		//! from json
		void Warp::fromJson(const JsonTree &json)
		{
			if (json.hasChild("warp")) {
				...
				mATextureFilename = (warp.hasChild("atexturefilename")) ? warp.getValueForKey<std::string>("atexturefilename") : "0.jpg";
				mBTextureFilename = (warp.hasChild("btexturefilename")) ? warp.getValueForKey<std::string>("atexturefilename") : "0.jpg";
